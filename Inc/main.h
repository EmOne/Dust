...
#define SOUND_LVL_Pin GPIO_PIN_3
#define SOUND_LVL_GPIO_Port GPIOA
...
#define DUST_RX_Pin GPIO_PIN_5
#define DUST_RX_GPIO_Port GPIOD
#define DUST_TX_Pin GPIO_PIN_6
#define DUST_TX_GPIO_Port GPIOD
